        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form method="post" action="{{ url('/save') }}">
                    ...
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" name="email" class="form-control" placeholder="Masukan email dengan benar"
                            value="{{ old('email') }}">
                        @if($errors->has('email'))
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <br>
                                <input type="hidden" name="identity_file" class="identity-photo">
                                <button type="button" onclick="openCameraDialog()"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="identity_id" class="form-control" placeholder="Masukan nomor identitas"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone_number" class="form-control" placeholder="Masukan nomor telepon"
    ...
    <script>
        ...
        function takeScreenshot(){
            Webcam.snap( function(data_uri) {
                $(".identity-photo").val(data_uri);
                document.getElementById('camera-result').innerHTML = '<img class="img-thumbnail" src="'+data_uri+'"/>';
            });
